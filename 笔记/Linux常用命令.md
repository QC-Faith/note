...
> 将当前目录及其子目录下==所有文件后缀为 **.c**== 的文件列出来: `find . -name "*.c"`
>
> 将当前目录及其子目录中的==所有文件==列出： `find . -type f`
>
> 将当前目录及其子目录下所有==最近 20 天内更新过==的文件列出 `find . -ctime -20`
>
